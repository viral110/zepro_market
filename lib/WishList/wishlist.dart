    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(top: 15, left: 12, bottom: 2),
              child: Row(
                children: [
                  // GestureDetector(
                  //     onTap: () {
            ...
            isGetFavourite != false && gwp != null
                ? Padding(
                    padding: const EdgeInsets.only(top: 2, left: 15, bottom: 3),
                    child: Text(
            ...
            isGetFavourite == false
                ...
                : Expanded(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          gwp != null && gwp.response.isNotEmpty
                              ? Expanded(
                                  flex: 0,
                                    ...
                                    itemBuilder: (context, index) {
                                      return Column(
                                        children: [
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      await ApiServices().addAndDeleteToFavourite(gwp
                                                                          .response[
                                                                              index]
                                                                          .productId);
                                                                      // gwp = null;
                                          ...
                                          if (gwp.response.length == index + 1)
                                            SizedBox(
